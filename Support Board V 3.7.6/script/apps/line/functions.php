 ...
 * ==========================================================
 *
 * Line app main file. © 2017-2024 board.support. All rights reserved.
 *
...
function sb_line_curl($url_part, $token, $query = '', $method = 'POST') {
    $response = sb_curl('https://api.line.me/v2/bot/' . $url_part, json_encode($query), ['Content-Type: application/json', 'Authorization: Bearer ' . $token], $method);
